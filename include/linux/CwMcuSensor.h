...
extern int compass_en_register_notifier(struct notifier_block *nb);
extern int compass_en_unregister_notifier(struct notifier_block *nb);
extern int compass_en_notifier_call_chain(bool val, void *v);
...
typedef enum {
	...
	CWSTM32_BATCH_MODE_8DATA_QUEUE                   = 0x4F,
	...
	CWSTM32_WAKE_UP_BATCH_MODE_8DATA_QUEUE           = 0x5F,
	...
	CW_I2C_REG_COMPASS_FILTER                        = 0x71,
