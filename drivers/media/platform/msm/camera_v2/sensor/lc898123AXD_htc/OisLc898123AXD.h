...
#define MIXING_DATA_TOP			( FLASH_SECTOR_BUFFER + 0x0000005C )
#define MIXING_HXSX				( FLASH_SECTOR_BUFFER + 0x0000005C )
#define MIXING_HYSX				( FLASH_SECTOR_BUFFER + 0x0000005E )
#define MIXING_HX45X			( FLASH_SECTOR_BUFFER + 0x00000060 )
#define MIXING_HX45Y			( FLASH_SECTOR_BUFFER + 0x00000064 )
#define MIXING_HY45Y			( FLASH_SECTOR_BUFFER + 0x00000068 )
#define MIXING_HY45X			( FLASH_SECTOR_BUFFER + 0x0000006C )

#define MIXING_GX45X			( FLASH_SECTOR_BUFFER + 0x00000070 )
#define MIXING_GX45Y			( FLASH_SECTOR_BUFFER + 0x00000074 )
#define MIXING_GY45Y			( FLASH_SECTOR_BUFFER + 0x00000078 )
#define MIXING_GY45X			( FLASH_SECTOR_BUFFER + 0x0000007C )
#define MIXING_GXSX				( FLASH_SECTOR_BUFFER + 0x00000088 )
#define MIXING_GYSX				( FLASH_SECTOR_BUFFER + 0x0000008A )
#define CALIBRATION_ID			( FLASH_SECTOR_BUFFER + 0x0000008C )
...
#define	LN_ZONE1_COEFAX			( FLASH_SECTOR_BUFFER + 0x000000B0 )
#define	LN_ZONE1_COEFAY			( FLASH_SECTOR_BUFFER + 0x000000B2 )
#define	LN_ZONE2_COEFAX			( FLASH_SECTOR_BUFFER + 0x000000B4 )
#define	LN_ZONE2_COEFAY			( FLASH_SECTOR_BUFFER + 0x000000B6 )
#define	LN_ZONE3_COEFAX			( FLASH_SECTOR_BUFFER + 0x000000B8 )
#define	LN_ZONE3_COEFAY			( FLASH_SECTOR_BUFFER + 0x000000BA )
#define	LN_ZONE4_COEFAX			( FLASH_SECTOR_BUFFER + 0x000000BC )
#define	LN_ZONE4_COEFAY			( FLASH_SECTOR_BUFFER + 0x000000BE )
#define	LN_ZONE5_COEFAX			( FLASH_SECTOR_BUFFER + 0x000000C0 )
#define	LN_ZONE5_COEFAY			( FLASH_SECTOR_BUFFER + 0x000000C2 )
#define	LN_ZONE6_COEFAX			( FLASH_SECTOR_BUFFER + 0x000000C4 )
#define	LN_ZONE6_COEFAY			( FLASH_SECTOR_BUFFER + 0x000000C6 )

#define	LN_ZONE1_COEFB			( FLASH_SECTOR_BUFFER + 0x000000C8 )
#define	LN_ZONE1_COEFBX			( FLASH_SECTOR_BUFFER + 0x000000C8 )
#define	LN_ZONE1_COEFBY			( FLASH_SECTOR_BUFFER + 0x000000CA )
#define	LN_ZONE2_COEFBX			( FLASH_SECTOR_BUFFER + 0x000000CC )
#define	LN_ZONE2_COEFBY			( FLASH_SECTOR_BUFFER + 0x000000CE )
#define	LN_ZONE3_COEFBX			( FLASH_SECTOR_BUFFER + 0x000000D0 )
#define	LN_ZONE3_COEFBY			( FLASH_SECTOR_BUFFER + 0x000000D2 )
#define	LN_ZONE4_COEFBX			( FLASH_SECTOR_BUFFER + 0x000000D4 )
#define	LN_ZONE4_COEFBY			( FLASH_SECTOR_BUFFER + 0x000000D6 )
#define	LN_ZONE5_COEFBX			( FLASH_SECTOR_BUFFER + 0x000000D8 )
#define	LN_ZONE5_COEFBY			( FLASH_SECTOR_BUFFER + 0x000000DA )
#define	LN_ZONE6_COEFBX			( FLASH_SECTOR_BUFFER + 0x000000DC )
#define	LN_ZONE6_COEFBY			( FLASH_SECTOR_BUFFER + 0x000000DE )

#define	LN_ZONE1_THR			( FLASH_SECTOR_BUFFER + 0x000000E0 )
#define	LN_ZONE1_THRX			( FLASH_SECTOR_BUFFER + 0x000000E0 )
#define	LN_ZONE1_THRY			( FLASH_SECTOR_BUFFER + 0x000000E2 )
#define	LN_ZONE2_THRX			( FLASH_SECTOR_BUFFER + 0x000000E4 )
#define	LN_ZONE2_THRY			( FLASH_SECTOR_BUFFER + 0x000000E6 )
#define	LN_ZONE3_THRX			( FLASH_SECTOR_BUFFER + 0x000000E8 )
#define	LN_ZONE3_THRY			( FLASH_SECTOR_BUFFER + 0x000000EA )
#define	LN_ZONE4_THRX			( FLASH_SECTOR_BUFFER + 0x000000EC )
#define	LN_ZONE4_THRY			( FLASH_SECTOR_BUFFER + 0x000000EE )
...
#define			HF_ShiftY						0x0011 + HF_MIXING
