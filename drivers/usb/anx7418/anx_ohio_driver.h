...
static unsigned char inactive_word[9] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}; //ECC is set to 0xFF
...
/*checked Ohio's downstream type-c interface is  connected with Dongle or adapter or not */
