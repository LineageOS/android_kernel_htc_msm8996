 ...
 *
 * $Id: dhd.h 619254 2016-02-16 04:17:55Z $
 */
...
#endif
#define MAX_NVRAMBUF_SIZE	(16 * 1024) 
#ifdef DHD_DEBUG
#define DHD_JOIN_MAX_TIME_DEFAULT 10000 
#define DHD_SCAN_DEF_TIMEOUT 10000 
#endif
...
enum dhd_dongledump_type {
	...
	DUMP_TYPE_READ_SHM_FAILED,
#ifdef CUSTOMER_HW_ONE
	DUMP_TYPE_USER_TRIGGER,
	
	DUMP_TYPE_SCAN_AP_COUNT_ZERO,
...
#define DHD_CUMM_CTR(clen)         *(DHD_CUMM_CTR_PTR(clen)) 
#define DHD_CUMM_CTR_READ(clen)    DHD_CUMM_CTR(clen) 
 ...
 */
...
#endif
#if defined(CUSTOMER_HW_ONE) || defined(CUSTOM_SET_CPUCORE)
	...
	bool	flow_rings_inited;	
#endif 
	void    *flowid_allocator;  
	void	*flow_ring_table;   
	void	*if_flow_lkup;      
	void    *flowid_lock;       
	void    *flowring_list_lock;       
	uint32  num_flow_rings;
	cumm_ctr_t cumm_ctr;        
	cumm_ctr_t l2cumm_ctr;      
	...
	uint16 memdump_in_progress;
	uint16 memdump_with_hang_pending;
#endif 
#ifdef PCIE_FULL_DONGLE
#ifdef WLTDLS
...
extern int dhd_get_assoc_status(void);
...
#else
#define RPS_CPUS_MASK "c"
#define RPS_CPUS_MASK_P2P "c"
#define RPS_CPUS_MASK_IBSS "c"
#endif 
#endif
...
#else 
#define DHD_LB_STATS_NOOP       do {  } while (0)
...
#define TEMP_THROTTLE_CONTROL_BIT 0xf   
#endif 
