 ...
 *
 * $Id: wl_cfg80211.h 620888 2016-02-24 08:55:09Z $
 */
...
#ifdef CFG80211_ERROR_TEXT
#undef CFG80211_ERROR_TEXT
#define CFG80211_ERROR_TEXT		"[WLAN] CFG80211-LOG) "
#endif
#define CFG80211_INFORM_TEXT		"[WLAN] CFG80211-INFO) "
#define CFG80211_SCAN_TEXT		"[WLAN] CFG80211-SCAN) "
#define CFG80211_TRACE_TEXT		"[WLAN] CFG80211-TRACE) "
#define CFG80211_DEBUG_TEXT		"[WLAN] CFG80211-DEBUG) "
#else
#define CFG80211_INFORM_TEXT		"CFG80211-INFO) "
...
do {										\
	if (wl_dbg_level & WL_DBG_INFO) {				\
			printk(KERN_INFO CFG80211_INFORM_TEXT "%s : ", __func__);	\
			printk args;						\
		}								\
} while (0)
...
do {									\
	if (wl_dbg_level & WL_DBG_SCAN) {			\
		printk(KERN_INFO CFG80211_SCAN_TEXT "%s :", __func__);	\
		printk args;							\
	}									\
} while (0)
#ifdef WL_TRACE
...
do {									\
	if (wl_dbg_level & WL_DBG_TRACE) {			\
		printk(KERN_INFO CFG80211_TRACE_TEXT "%s :", __func__);	\
		printk args;							\
	}									\
} while (0)
#ifdef WL_TRACE_HW4
...
do {									\
	if (wl_dbg_level & WL_DBG_DBG) {			\
		printk(KERN_DEBUG CFG80211_DEBUG_TEXT "%s :", __func__);	\
		printk args;							\
	}									\
} while (0)
#else				
...
#define WL_ROAM_TIMEOUT_MS	1000 
#endif
...
extern void wl_set_band_disconnect(struct net_device *ndev);
extern bool wl_check_channel_band_mismatch(int band, int channel);
#endif 
...
#endif 
void wl_cfg80211_extra_disc(void);
#endif 
