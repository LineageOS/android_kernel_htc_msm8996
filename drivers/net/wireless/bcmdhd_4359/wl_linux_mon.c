 ...
 *
 * $Id: wl_linux_mon.c 578000 2015-08-10 03:18:38Z $
 */
...
#define MON_PRINT_TEXT		"[WLAN] DHD-MON) "
#else
#define MON_PRINT_TEXT		"DHD-MON) "
#endif 
#define MON_PRINT(format, ...) printk(MON_PRINT_TEXT "%s: " format, __func__, ##__VA_ARGS__)
