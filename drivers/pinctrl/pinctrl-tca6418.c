...
static int tca6418_gpio_request(struct gpio_chip *chip, unsigned offset)
{
        return pinctrl_request_gpio(chip->base + offset);
}

static void tca6418_gpio_free(struct gpio_chip *chip, unsigned offset)
{
...
static struct gpio_chip tca6418_chip = {
	...
	.request          = tca6418_gpio_request,
	.free             = tca6418_gpio_free,
};
