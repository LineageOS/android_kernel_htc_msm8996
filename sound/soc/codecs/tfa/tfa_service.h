...
#define TFA98XX_API_REV_MAJOR			(2)	
#define TFA98XX_API_REV_MINOR			(10)	
...
#define TFA2_SPEAKERPARAMETER_LENGTH		(3*151)	
#define TFA1_SPEAKERPARAMETER_LENGTH		(3*141)	

#define TFA2_ALGOPARAMETER_LENGTH		(3*304)	
#define TFA2_MBDRCPARAMETER_LENGTH		(3*152)	
#define TFA1_PRESET_LENGTH			87
#define TFA1_DRC_LENGTH				381	
...
enum Tfa98xx_Error {
    ...
    Tfa98xx_Error_Fail,             
	Tfa98xx_Error_NoClock,          
	Tfa98xx_Error_StateTimedOut,
	Tfa98xx_Error_DSP_not_running,	
	Tfa98xx_Error_AmpOn,            
	Tfa98xx_Error_NotOpen,	        
	Tfa98xx_Error_InUse,	        
    Tfa98xx_Error_Buffer_too_small, 
...
enum Tfa98xx_SpeakerBoostStatusFlags {
	Tfa98xx_SpeakerBoost_Activity = 0,	
	Tfa98xx_SpeakerBoost_S_Ctrl,	
	Tfa98xx_SpeakerBoost_Muted,	
	Tfa98xx_SpeakerBoost_X_Ctrl,	
	Tfa98xx_SpeakerBoost_T_Ctrl,	
	Tfa98xx_SpeakerBoost_NewModel,	
	Tfa98xx_SpeakerBoost_VolumeRdy,	
	Tfa98xx_SpeakerBoost_Damaged,	
	Tfa98xx_SpeakerBoost_SignalClipping	
};
